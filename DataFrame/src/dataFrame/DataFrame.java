...
public class DataFrame {
     ...
     */
    public DataFrame(String fileName, Class<? extends Value>[] types, double progress) {
        String[] data = Util.loadFile(fileName);
        String[] columnNames = data[0].split(",");
     ...
     * @param progress    reference to a variable storing progress of the loading.
     */
    public DataFrame(String fileName, Class<? extends Value>[] types, String[] columnNames, double progress) {
        String[] data = Util.loadFile(fileName);
